 ...
 * @author agrah
 */
public class RockPaperScissorsV1_1 {
        ...
        do{
            ...
            if(numOfRounds < 1 || numOfRounds > 10){
                ...
                for(int i = numOfRounds; i > 0; i--){
                    ...
                    switch (getRoundResults(getUserMove(), getComputerMove())) {
                        case 0: //tie case
                            ties++;
                            break;
    ...
    public static String getUserMove(){
        ...
        String uMoveStr = "";
            ...
            if(uMoveInt <= 0 || uMoveInt > 3){
                System.out.println("Sorry that is not a valid move.");
            }
  
        return getMoveString(uMoveInt);
    }
    ...
    public static String getComputerMove(){
        ...
        return getMoveString(compNum);
    }
    
    //method to return the string equivalent of player and computer moves
